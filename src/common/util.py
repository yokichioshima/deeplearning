...
# 指定されたモデルと指定された質問、正解の組み合わせでシーケンスを評価します。
# param: model。
# param: question: 質問。
# param: correct: 正解。
# param: id_to_char: 単語 ID から単語へのディクショナリ。
# param: verbose: 詳細な情報を表示するかどうか。
# param: is_reverse: 逆順で評価するかどうか。
def eval_seq2seq(
    model,
    question: np.ndarray[np.int32],
    correct: np.ndarray[np.int32],
